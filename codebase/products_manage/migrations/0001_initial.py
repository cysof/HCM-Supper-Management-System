# Generated by Django 5.0.4 on 2024-05-20 16:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='products', to='products_manage.category')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
